...
import com.service.nearby.repository.ServiceRepository;
...
public class ServiceResource {
    ...
    @GetMapping("/services")
    @Timed
    public ResponseEntity<List<Service>> getAllServices(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/services?eagerload=%b", eagerload));
