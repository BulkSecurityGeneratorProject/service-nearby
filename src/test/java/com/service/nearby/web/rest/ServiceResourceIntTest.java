...
import static com.service.nearby.web.rest.TestUtil.createFormattingConversionService;
...
public class ServiceResourceIntTest {
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.getTest()).isEqualTo(DEFAULT_TEST);
    }
    ...
    public void getAllServicesWithEagerRelationshipsIsEnabled() throws Exception {
        ServiceResource serviceResource = new ServiceResource(serviceRepositoryMock);
    ...
    public void updateService() throws Exception {
        ...
        assertThat(testService.getTest()).isEqualTo(UPDATED_TEST);
    }
